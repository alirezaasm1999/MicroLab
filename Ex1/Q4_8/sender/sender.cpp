...
char data[200] = "Hello, this message sends from Ali Asmaee with student number 972023004 from one microcontroller that name is 'sender' to another microcontroller 'receiver' and shows a message in LCD.";
